  ...
  return (
    <div className="flex flex-col gap-4 p-4 md:p-8">
        ...
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              ...
              {rows.length === 0 && (
                <TableRow>
                  <TableCell colSpan={mostrandoPerdidos ? 8 : 7} className="py-10 text-center text-sm text-muted-foreground">
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        <span>
          {filtered.length} lead{filtered.length === 1 ? "" : "s"} · página {safePage} de {pageCount}
        </span>
