/**
 * (E3) Webhook de observabilidade da Z-API — instância reconectada.
 */
...
export const Route = createFileRoute("/api/public/zapi/conectado")({
  server: {
    handlers: {
      ...
      POST: async ({ request }) => {
        ...
        return tratarEventoZapi(request, "conectado");
      },
    },
  },
});
