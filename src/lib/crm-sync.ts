...
function rowToProposal(
  ...
  return {
    ...
    encerramentoAdministrativo: r.encerramento_administrativo ?? false,
    createdAt: r.created_at,
    ...
    motivoRecusa: (r as unknown as { motivo_recusa?: string | null }).motivo_recusa ?? null,
    recusaDetalhe: (r as unknown as { recusa_detalhe?: string | null }).recusa_detalhe ?? null,
    recusadaEm: (r as unknown as { recusada_em?: string | null }).recusada_em ?? null,
